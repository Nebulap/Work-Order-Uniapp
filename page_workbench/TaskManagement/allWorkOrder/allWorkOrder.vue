...
function jumpaTask(state: string, Id: number, item: WorkOrderTaskViewmodel) {
  const statePathMap: { [key: string]: string } = {
    ...
    '2': `/page_workbench/TaskManagement/disposeHarmonizeTask/disposeHarmonizeTask?item=${encodeURIComponent(JSON.stringify(item))}&taskType=我发起的工单&detail=ture`,
    ...
    '6': `/page_workbench/TaskManagement/disposeHarmonizeTask/disposeHarmonizeTask?item=${encodeURIComponent(JSON.stringify(item))}&taskType=我发起的工单&detail=ture`
  }
